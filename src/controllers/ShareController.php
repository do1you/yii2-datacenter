...
class ShareController extends \webadmin\BController
{
    ...
    */
    ...
    public function actionCreate()
    {
        ...
        $model->invalid_time = date('Y-m-d 00:00:00', strtotime('+3 day'));
    ...
    public function actionDelete()
    {
        ...
        if($id && ($models = DcShare::findAll($id))){
        	$transaction = DcShare::getDb()->beginTransaction(); // 使用事务关联
    ...
    {
        if (($model = DcShare::findOne($id)) !== null) {
            return $model;
        }
