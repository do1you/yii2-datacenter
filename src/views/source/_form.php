	...
	<div class="col-xs-12">
		...
		<div class="widget flat radius-bordered">
			<div class="widget-header bg-themeprimary">
			    <span class="widget-caption">数据源 <?php echo $model->id ? $model['name'] : '新增'?></span>
			</div>
			    ...
			    <div class="widget-main ">
			    	...
			    	<div class="tabbable">
        			    <ul class="nav nav-tabs tabs-flat">
    		    			...
    		    			<li><a data-toggle="tab" href="#tab_model" aria-expanded="false">模型信息</a></li>
        			    </ul>
        			    <div class="tab-content tabs-flat">
        		    		...
        		    		<div id="tab_model" class="tab-pane">
        		    			<?= $this->render('_model', [
                                    'model' => $model,
                                ]) ?>
        		    		</div>
