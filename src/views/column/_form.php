...
<div class="row dc-attribute-form">
	<?php $form = ActiveForm::begin(); ?>
		<div class="col-lg-offset-3 col-sm-offset-1 col-lg-6 col-sm-10 col-xs-12">
            
            <?= $form->field($model, 'model_id')->textInput()->selectajax(\yii\helpers\Url::toRoute('model'),[]) ?>
            
            <?= $form->field($model, 'name')->textInput(['maxlength' => true]) ?>

            <?= $form->field($model, 'label')->textInput(['maxlength' => true]) ?>

            <?= $form->field($model, 'type')->textInput(['maxlength' => true])->select2($model->getV_type(false), []) ?>

            <?= $form->field($model, 'length')->textInput() ?>

            <?= $form->field($model, 'is_visible')->textInput()->select2($model->getV_is_visible(false), []) ?>
