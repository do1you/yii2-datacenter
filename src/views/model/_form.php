...
<div class="row">
	<div class="col-xs-12">
		<div class="pull-right inline">
			...
			<a class="btn btn-primary" data-pjax="0" href="<?php echo Url::to(!empty(Yii::$app->session[Yii::$app->controller->id]) ? Yii::$app->session[Yii::$app->controller->id] : ['index'])?>"><i class="ace-icon glyphicon glyphicon-list bigger-110"></i> <?php echo Yii::t('common','列表')?></a>
	...
	<div class="col-xs-12">
		...
		<div class="widget flat radius-bordered">
			<div class="widget-header bg-themeprimary">
			    <span class="widget-caption">数据模型 <?php echo $model->id ? $model['tb_name'].' '.$model['tb_label'] : '新增'?></span>
			</div>
			    ...
			    <div class="widget-main ">
			    	...
			    	<div class="tabbable">
        			    <ul class="nav nav-tabs tabs-flat">
    		    			...
    		    			<?php if($model['id']):?>
    		    				<li><a data-toggle="tab" href="#tab_column" aria-expanded="false">模型字段</a></li>
    		    				<li><a data-toggle="tab" href="#tab_relation" aria-expanded="false">模型关系</a></li>
    		    			<?php endif;?>
        			    </ul>
